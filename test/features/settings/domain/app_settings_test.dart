...
void main() {
  group('AppSettings', () {
    test('documented defaults', () {
      ...
      expect(settings.chartsAtTop, isTrue);
    });
    ...
    test('copyWith overrides only the given fields', () {
      ...
      expect(updated.chartsAtTop, settings.chartsAtTop);
    });
    ...
    test('copyWith overrides chartsAtTop independently', () {
      const settings = AppSettings();

      final updated = settings.copyWith(chartsAtTop: false);

      expect(updated.chartsAtTop, isFalse);
      expect(updated.detectColorPeaks, settings.detectColorPeaks);
    });
